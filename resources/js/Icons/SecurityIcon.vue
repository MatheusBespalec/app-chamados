<template>
<!--    <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" :class="classes" fill="currentColor" class="bi bi-shield-fill" viewBox="0 0 16 16">-->
...
<!--    </svg>-->
    <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" :class="classes" fill="currentColor" class="bi bi-shield-shaded" viewBox="0 0 16 16">
